...
export class CameraController {
    ...
    public onTransitionUpdate: ((progress: number, actNumber: number) => void) | null = null;
     ...
     */
    public transitionToAct(actNumber: number, duration: number | null = null): boolean {
     ...
     */
    public setCustomPosition(position: THREE.Vector3, lookAt: THREE.Vector3 | null = null): void {
        if (this.isTransitioning) {
            this.stopTransition();
        }
