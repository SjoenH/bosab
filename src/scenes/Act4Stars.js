...
export class Act4Stars {
    ...
    update(deltaTime) {
        ...
        // Get audio data using the correct methods
        const bassIntensity = this.audioAnalyzer.getLowFreq();
        const midIntensity = this.audioAnalyzer.getMidFreq();
        const trebleIntensity = this.audioAnalyzer.getHighFreq();
        const averageIntensity = this.audioAnalyzer.getAverageFrequency();
