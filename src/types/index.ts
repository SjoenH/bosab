...
export interface ParticleSystemConfig {
    ...
    updateFunction?: (particles: THREE.Points, audioData: AudioData, deltaTime: number) => void
}
...
export interface CameraControllerInterface {
    ...
    setCustomPosition(position: THREE.Vector3, lookAt?: THREE.Vector3 | null): void;
